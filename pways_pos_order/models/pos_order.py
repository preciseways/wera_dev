...
class PosOrder(models.Model):
    ...
    def fetch_tax_details(self, taxes):
        ...
        gst = {
            ...
            "sgst": sgst,
            "inclusive": False,
            "gst_liability": taxes.gst_liability if taxes.gst_liability else None
        } if taxes else None
    ...
    #             variant_group = []
    #             if product.attribute_line_ids:
    #                 default_variant_id = False
    #                 default_variant_group_id = False
    #                 for rec in product.attribute_line_ids:
    #                     variant_group_dict = {
    #                     "id": str(rec.attribute_id.id),
    #                     "name": str(rec.attribute_id.name),
    #                     "order": 0,
    #                     "variants": []
    #                     }
    #                     if rec.product_template_value_ids:
    #                         print("value_ids---------------",rec.product_template_value_ids)
    #                         for x in rec.product_template_value_ids:
    #                             print("x-------------",x)
    #                             variant = {
    #                                 "id": str(x.product_attribute_value_id.id) ,
    #                                 "name": str(x.name),
    #                                 "price": int(x.price_extra),
    #                                 "default": False,
    #                                 "is_veg": 1,
    #                                 "in_stock": 1,
    #                                 "order":  1,
    ...
    #                             variant_group_dict["variants"].append(variant)
    #                             default_variant_id = str(x.product_attribute_value_id.id)
    #                     variant_group.append(variant_group_dict)
    #                     default_variant_group_id = str(rec.attribute_id.id)
    #             print("variant_group-----------------",variant_group)
    #             if product.addons_group_ids:
    #                 for addon_group in product.addons_group_ids:
    #                     addon_group_dict = {
    #                         "id": addon_group.id,
